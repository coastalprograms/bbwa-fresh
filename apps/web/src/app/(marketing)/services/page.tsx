        ...
        <div className="container">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 gap-8 max-w-4xl mx-auto">
              ...
              <AnimatedSection variant="slideLeft" bidirectional={true} delay={0.1}>
              ...
              <AnimatedSection variant="slideUp" bidirectional={true} delay={0.2}>
        ...
        <div className="container">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid md:grid-cols-4 gap-6 pb-20">
              ...
              <AnimatedSection variant="slideLeft" bidirectional={true} delay={0.4}>
              ...
              <AnimatedSection variant="slideRight" bidirectional={true} delay={0.5}>
                  ...
                  <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-slate-100">
                      <video 
                        ...
                        controls
                        preload="metadata"
                        poster="https://dslerptraitfgcmxkhkq.supabase.co/storage/v1/object/public/media/videos/BaysideBuildersWA_Mewett_Rd_4k%20(2).mp4?t=1s"
                      >
                        <source 
                          src="https://dslerptraitfgcmxkhkq.supabase.co/storage/v1/object/public/media/videos/BaysideBuildersWA_Mewett_Rd_4k%20(2).mp4" 
                          type="video/mp4" 
                        />
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-4">
              {[
                ...
                <AnimatedSection key={index} variant="simpleFade" bidirectional={true} delay={0.2 + (index * 0.1)}>
